...
<head>
    ...
    <link type="text/css" href="/static/interface%20style/style.css" rel="stylesheet">-->
    <link rel="stylesheet" type="text/css" href="<@spring.url '/css/style.css'/>"/>
    <link type="text/css" href="/static/interface-style/style.css" rel="stylesheet">
</head>
<body style="background-color: #93F763">

 <div class="text">
<h1 style="">Client List</h1>
  </div>
